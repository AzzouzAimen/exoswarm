...
def test_compiled_langgraph_is_the_only_controller_topology(tmp_path) -> None:
    ...
    expected_edges = {
        ...
        (
            "director_route",
            "specialist_briefing",
            "RUN_SPECIALIST_BRIEFING",
            True,
        ),
        (
            "director_route",
            "director_briefing",
            "CALL_DIRECTOR_BRIEFING",
            True,
        ),
        ...
        ("specialist_briefing", "director_briefing", None, False),
        ("director_briefing", "skeptic_decision", None, False),
        ...
        ("evaluate_result", "finalize", "FINALIZE", True),
        ("evaluate_result", "__end__", "NOOP_TERMINAL", True),
